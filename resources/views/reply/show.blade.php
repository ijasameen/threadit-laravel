...
<x-layout.app>
    <div class="w-full max-w-3xl mx-auto space-y-3">
        ...
        <div id="basic-collapse-heading" class="collapse hidden w-full overflow-hidden transition-[height] duration-300"
            ...
            <div class="flex gap-x-2 mb-3">
                <div class="flex items-center">
                    ...
                    <button type="button"
                        class="btn btn-soft rounded-br-full rounded-tr-full text-secondary-content pl-2">
        ...
        <x-card.reply class="bg-base-200 border-1 border-neutral mb-4 p-6 rounded-lg" :$reply />
        @auth
